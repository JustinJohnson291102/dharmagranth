...
export const hindiVideos: Video[] = [
  ...
  { id: 'h6', title: 'अच्चुतम केशवं कृष्ण दामोदरं - भजन', description: 'अच्चुतम केशवं कृष्ण दामोदरं, राम नारायणं जानकी बल्लभम । कौन कहता हे भगवान आते नहीं..', thumbnailUrl: 'https://images.unsplash.com/photo-1629479335213-94c636a28723?q=80&w=2070&auto=format&fit=crop', thumbnailHint: 'krishna statue', genre: 'भजन', teacher: 'संत परंपरा' },
